...
5. BONUS: Add a `Contact` section below the `Projects` section. Add contact information (real/fake use your best judgement), social media, links, embed a google map, etc.# wd-m1-knowledge-check
# wd-m1-knowledge-check
# wd-m1-knowledge-check
# wd-m1-knowledge-check
# wd-knowledge-check-m1
